...
public class MascotasFragment extends Fragment implements View.OnClickListener {
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        binding.btnAgregarMascotaView.setOnClickListener(this);
    ...
    public void onClick(View v) {
        ...
        if (v.getId() == R.id.btnAgregarMascotaView){
            NavHostFragment.findNavController(this).navigate(R.id.agregarMascotaFragment);
        }
